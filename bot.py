...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'start_quiz':
        ...
        reply_markup = InlineKeyboardMarkup(keyboard)
        await query.edit_message_text(text="*Please select your language: [Hindi, English]*", reply_markup=reply_markup, parse_mode="Markdown")
        ...
        reply_markup = InlineKeyboardMarkup(keyboard)
        await query.edit_message_text(text=f"*Language selected: {language.upper()}\nPlease select your category: [SSC, RRB]*",
                                      reply_markup=reply_markup, parse_mode="Markdown")
        ...
        reply_markup = InlineKeyboardMarkup(keyboard)
        await query.edit_message_text(text=f"Category selected: {category.upper()}\n*Please select the interval for quizzes: using this command /setinterval *\nSet the interval for quizzes - [Ex. /setinterv...]",
                                      reply_markup=reply_markup, parse_mode="Markdown")
        ...
        reply_markup = InlineKeyboardMarkup(keyboard)
        await query.edit_message_text(text="Please select your language:", reply_markup=reply_markup)
        ...
        reply_markup = InlineKeyboardMarkup(keyboard)
        await query.edit_message_text(text="Please select your category:", reply_markup=reply_markup)
        ...
        if not top_scores:
            ...
            await update.effective_message.reply_text("🏆 No scores yet! Start playing to appear on the leaderboard.")
            return
        ...
        await update.effective_message.reply_text(f"Your current score is: {score} points.")
        ...
        reply_markup = InlineKeyboardMarkup(keyboard)
        await query.edit_message_text(text=f"Available Commands:\n{commands_description}", reply_markup=reply_markup)
        ...
        reply_markup = InlineKeyboardMarkup(keyboard)
        await query.edit_message_text(text="Welcome to the Quiz Bot! Please choose an option:", reply_markup=reply_markup)
